...
import { HARDCODED_MEDICINE_DATA } from '@/constants/staticData';
...
export default function EnhancedPrescriptionOCR() {
    ...
    const { searchMedicines, loading, error, reset } = useMedicineSearch('AIzaSyAytcxEFiYO3jZvFg2sfaSD8UlE9KxvVwo');
    const [result, setResult] = useState<MedicineSearchResult | null>(HARDCODED_MEDICINE_DATA);
    ...
    const API_BASE_URL = 'https://b70d09061dbc.ngrok-free.app';
    ...
    const renderResults = (): React.ReactNode => {
        ...
        return (
            <ScrollView className="flex-1 pt-[20px]" showsVerticalScrollIndicator={false}>
    ...
    const isLoading = ocrLoading || loading;
    ...
    return (
        <SafeAreaView className="flex-1 bg-gray-50">
            ...
            {currentStep === 'results' && (
                <MedicineDisplay result={result} resetToStart={resetToStart} />
            )}
        </SafeAreaView >
    );
}